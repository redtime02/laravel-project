        ...
        <div class="container">
                        ...
                        @forelse ($cart as $cartItem)
                            ...
                            <div class="cart-item">
                                <div class="row">
                                    ...
                                    <div class="col-md-2 my-auto">
                                        <label class="price">{{ $cartItem->product->selling_price * $cartItem->quantity }} VND</label>
            ...
            <div class="row">
                <div class="col-md-8 my-md-auto mt-3">
                    {{-- <h4>
                        Get the best deals & Offers <a href="{{ url('/collections') }} " class="btn btn-primary">Shop Now</a>
                    </h4> --}}
                </div>
                <div class="col-md-4 mt-3">
                    <div class="shadow-sm bg-white p-3">
                        <h5>Thành tiền:
                            <span class="float-end">{{ $totalPrice }} VND</span>
                        </h5>
                        <hr>
                        <a href="{{ url('/checkout') }}" class="btn btn-warning w-100">Đặt hàng</a>
                    </div>
                </div>
            </div>
        </div>
