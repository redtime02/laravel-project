    ...
    <div class="top-navbar">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-5 my-auto search-bar">
                    <form action="{{ url('search') }}" method="GET" role="search">
                        <div class="input-group">
                            <input type="search" name="search" id="search" value="{{ Request::get('search') }}" placeholder="Tìm kiếm sản phẩm" class="form-control" />
                ...
                <div class="col-md-5 my-auto">
                    <ul class="nav justify-content-end">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <li><a class="dropdown-item" href="{{ url('/orders') }}"><i class="fa fa-list"></i> Lịch sử giao dịch</a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/blogs') }}">Tin Tức</a>
                    </li>
                </ul>
            </div>
        </div>
